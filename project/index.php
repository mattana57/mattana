...
<style>
body{ background: radial-gradient(circle at 20% 30%, #4b2c63 0%, transparent 40%), radial-gradient(circle at 80% 70%, #6a1b9a 0%, transparent 40%), linear-gradient(135deg,#120018,#2a0845,#3d1e6d); color:#fff; font-family:'Segoe UI',sans-serif; }
                ...
                <div class="mt-auto">
                    ...
                    <?php if(isset($_SESSION['user_id'])){ ?>
                        <div class="d-flex gap-1 mt-2">
                            <button onclick="addToCart(<?= $p['id'] ?>)" class="btn btn-warning btn-sm w-50">
                                 <i class="bi bi-cart-plus"></i> ตะกร้า
                            </button>
